...
TODO Hier das Bild amd_process hin. Dort die Schritte nummerieren (keine Formeln ins Bild, zu schwierig).
Hier dann die einzelnen Schritte mit Formeln erklären.
1. Beziehen auf vmmr workflow. Dict Gen startet mit Local Descriptors per RoI. Hier starten wir jeweils einen Prozess mit den Local Descriptors per RoI einer Klasse c_i (analog zu generation of MD in TODO ref chapter). Hier dann die Formel für alle f1..fN
2. Clustering aller feature descriptors zu k_c clustern omega_1, .., omega_k_c
3. Aussortieren der schlechten Clusters. Formel mit Omega-Menge und lc1. Erklären, wie man auf r_c_i kommt: ratio * numInstances(c_i)
4. Transformation der Clustercenter zu neuen feature descriptors f1'
5. Über die neuen Feature descriptors ALLER Klassen dann wiederum nochmal clustern zu k clustern
