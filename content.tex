...
\subsection{General}
Nowadays, vision-based recognition is a hot topic. Not possible to imagine automated manufacturing without it since many years, vision-based recognition became accessible for normal users with devices like the Microsoft Kinect (TODO: reference), which is able to perform gesture recognition, for example. Another visual recognition which arrested attention (mainly because of privacy issues TODO: source) in early 2015 was Facebook’s (TODO: source) face recognition system named DeepFace [24], which searches photos, taken by Facebook users, for people of other Facebook users.
...
Another approach that tries to eliminate all the cons of the system proposed by Petrovic et al. [1] (TODO name) is made by A. J. Siddiqui [3] (TODO name). Since that system is similar to the system proposed in this thesis, it will be discussed in more detail, here.
