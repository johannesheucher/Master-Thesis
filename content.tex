...
The Server is realized as a Java application. 


Dabei wird in den subsections die Reihenfolge eingehalten, wie sie im vmmr workflow beschrieben ist.
Server is realized as a Java application.
For image processing, OpenCV 3\footnote{\url{http://opencv.org/}} is used. For training the final classifier, Weka 3.8\footnote{\url{http://www.cs.waikato.ac.nz/ml/weka/}} is used.
