...
To create a successful exergame that motivates its players to do something for their health, following requirements (GR for game request) can be deduced from the previously said:
\begin{description}
