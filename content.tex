...
\begin{figure}[btph]
  \centering
        \includegraphics[width=.7\linewidth]{gfx/Evaluation_pre}
...
\begin{figure}[btph]
  \centering
        \includegraphics[width=.7\linewidth]{gfx/Evaluation_post}
        \caption{Questionnaire with answers after the testing phase (created with Google Forms)}
        \label{fig:evaluationPost}
\end{figure}
\begin{figure}[btph]
  \centering
        \includegraphics[width=.7\linewidth]{gfx/Evaluation_post2}
        \caption{Questionnaire with answers after the testing phase (created with Google Forms)}
