...
The Server is realized as a Java application. For image processing, OpenCV 3\footnote{\url{http://opencv.org/}} is used. For training the final classifier, Weka 3.8\footnote{\url{http://www.cs.waikato.ac.nz/ml/weka/}} is used.
...
As a result, the final dataset consists of TODO N Bildern, $\hat{N_c} = TODO$ verschiedenen Makes und L verschiedenen Models. Their original sizes vary between TODO x TODO pixels.
