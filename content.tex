...
\begin{figure}[btph]
  \centering
        \includegraphics[width=.76\linewidth]{gfx/Evaluation_pre}
...
\begin{figure}[btph]
  \centering
        \includegraphics[width=.76\linewidth]{gfx/Evaluation_post}
...
\begin{figure}[btph]
  \centering
        \includegraphics[width=.4\linewidth]{gfx/Evaluation_post2}
        \caption{Questionnaire with answers after the testing phase (created with Google Forms)}
...
\begin{itemize}
  ...
  \item "Playing in a group" (author's note: A short-term tester played one afternoon in a group with two long-term testers)
